...
[DialectOS](https://github.com/Pastorsimon1798/DialectOS) handles all of this as an MCP server and CLI tool. 25 dialects, structure preservation, adversarial quality gates, 746 tests.
