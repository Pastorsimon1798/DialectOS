...
> = {
  ...
  elles: [
    // Singular forms
    { from: /\btodo\b/g, to: "elle" },
    { from: /\bTodo\b/g, to: "Elle" },
    { from: /\bTODO\b/g, to: "ELLE" },
    { from: /\btoda\b/g, to: "elle" },
    { from: /\bToda\b/g, to: "Elle" },
    { from: /\bTODA\b/g, to: "ELLE" },
    { from: /\bbienvenido\b/g, to: "bienvenide" },
    { from: /\bBienvenido\b/g, to: "Bienvenide" },
    { from: /\bBIENVENIDO\b/g, to: "BIENVENIDE" },
    { from: /\bbienvenida\b/g, to: "bienvenide" },
    { from: /\bBienvenida\b/g, to: "Bienvenide" },
    { from: /\bBIENVENIDA\b/g, to: "BIENVENIDE" },
    { from: /\bamigo\b/g, to: "amigue" },
    { from: /\bAmigo\b/g, to: "Amigue" },
    { from: /\bAMIGO\b/g, to: "AMIGUE" },
    { from: /\bamiga\b/g, to: "amigue" },
    { from: /\bAmiga\b/g, to: "Amigue" },
    { from: /\bAMIGA\b/g, to: "AMIGUE" },
    { from: /\bcompañero\b/g, to: "compañere" },
    { from: /\bCompañero\b/g, to: "Compañere" },
    { from: /\bCOMPANERO\b/g, to: "COMPANERE" },
    { from: /\bcompañera\b/g, to: "compañere" },
    { from: /\bCompañera\b/g, to: "Compañere" },
    { from: /\bCOMPANERA\b/g, to: "COMPANERE" },
    { from: /\bniño\b/g, to: "niñe" },
    { from: /\bNiño\b/g, to: "Niñe" },
    { from: /\bNIÑO\b/g, to: "NIÑE" },
    { from: /\bniña\b/g, to: "niñe" },
    { from: /\bNiña\b/g, to: "Niñe" },
    { from: /\bNIÑA\b/g, to: "NIÑE" },
    { from: /\busuario\b/g, to: "usuarie" },
    { from: /\bUsuario\b/g, to: "Usuarie" },
    { from: /\bUSUARIO\b/g, to: "USUARIE" },
    { from: /\busuaria\b/g, to: "usuarie" },
    { from: /\bUsuaria\b/g, to: "Usuarie" },
    { from: /\bUSUARIA\b/g, to: "USUARIE" },
    // Plural forms
